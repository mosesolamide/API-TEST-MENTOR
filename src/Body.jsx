...
export default function Body({country,index,capital,official,region,currencyName,currencySymbol,flag,status}){
    return(
        <ul className="grid grid-cols-9 items-center md:gap-3 text-[5px] sm:text-[7px] md:text-[9px] md:font-medium w-full px-4 bg-white my-1 rounded-[2px] h-[40px] shadow">
